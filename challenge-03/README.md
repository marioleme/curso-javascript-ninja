...
mostrarIdade();  /* "Olá, eu tenho 31 anos!"
...
mostrarAltura(); /*  "Minha altura é 1.59m. "s/;
...
pessoa.apresentacao();  /*  "Olá, eu sou  o  mario Oliveira, tenho 34 anos,  1.59 , meu peso é 80 e, só hoje, eu já caminhei 6  metros !" */
