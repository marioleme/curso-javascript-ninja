...
(function() {
    ...
    */
    console.log('\nOperation:');
    var operation = justMod2Or3.reduce(function(acumulado, lastItem) {
    ...
    */
    ...
    var name = ['ma', 'ri', 'o'];
    var reducename = name.reduce(function(acumulado, letra) {
        return acumulado + 'P' + letra;
    }, '')
    ...
    */
    ...
    /*
    Verifique se `justMod2Or3`
    é um array.Se
    for, mostre - o no console, no formato de String.*/
    console.log('\njustMod2Or3 é um array? Se for, a representação dele em String é:');
    var vericaArry = Array.isArray(justMod2Or3);
    if (Array.isArray(justMod2Or3) === true) {
        justMod2Or3 = justMod2Or3.join();
        console.log(justMod2Or3);
